...
contextBridge.exposeInMainWorld('setupBridge', {
  ...
  getStorageInfo: () => ipcRenderer.invoke('setup:getStorageInfo'),
  chooseStorageFolder: () => ipcRenderer.invoke('setup:chooseStorageFolder'),
  validateStorage: root => ipcRenderer.invoke('setup:validateStorage', root),
  completeStorage: root => ipcRenderer.invoke('setup:completeStorage', root),
